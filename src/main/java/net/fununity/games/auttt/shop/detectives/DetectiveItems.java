...
/**
 * All shop items of the {@link net.fununity.games.auttt.Role#DETECTIVE}.
...
public enum DetectiveItems implements ShopItems {
    ...
    YOUTH(5, 0, 2, 2, ShopYouth.class, new ItemStack(Material.BLAZE_POWDER), TranslationKeys.TTT_GAME_SHOP_ITEM_YOUTH_NAME, TranslationKeys.TTT_GAME_SHOP_ITEM_YOUTH_DESCRIPTION);
