...
public class ShopAdrenalin extends ShopItem {
    ...
    private static final ItemBuilder ITEM = new ItemBuilder(Material.POTION).addPotionEffect(new PotionEffect(PotionEffectType.SPEED, 20 * 10, 1, true, true, Color.BLUE)).setName(TranslationKeys.TTT_GAME_ITEM_SHOP_ADRENALIN_NAME).setLore(TranslationKeys.TTT_GAME_ITEM_SHOP_ADRENALIN_LORE);
