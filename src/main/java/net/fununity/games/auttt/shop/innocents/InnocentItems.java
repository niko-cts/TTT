...
public enum InnocentItems implements ShopItems {
    ...
    IRON_SWORD(3, 0, 1, 1, ShopIronSword.class, new ItemStack(Material.IRON_SOWRD), TranslationKeys.TTT_GAME_SHOP_ITEM_IRON_SWORD_NAME, TranslationKeys.TTT_GAME_SHOP_ITEM_IRON_SWORD_DESCRIPTION);
