...
public enum TraitorItems implements ShopItems {
    ...
    FIREBALL(4, 1, 5, 5, ShopFireball.class, new ItemStack(Material.FIREWORK_CHARGE), TranslationKeys.TTT_GAME_SHOP_ITEM_FIREBALL_NAME, TranslationKeys.TTT_GAME_SHOP_ITEM_FIREBALL_DESCRIPTION),
