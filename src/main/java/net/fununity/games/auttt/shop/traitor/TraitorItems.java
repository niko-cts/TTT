...
public enum TraitorItems implements ShopItems {
    ...
    TRAP_TICKET(1, 0, 10, 10, ShopTrapTicket.class, new ItemStack(Material.STONE_BUTTON), TranslationKeys.TTT_GAME_SHOP_ITEM_TRAP_TICKET_NAME, TranslationKeys.TTT_GAME_SHOP_ITEM_TRAP_TICKET_DESCRIPTION),
    ...
    NOM_NOM_DEVICE(3, 0, 1, 1, ShopNomNomDevice.class, new ItemStack(Material.DISPENSER), TranslationKeys.TTT_GAME_SHOP_ITEM_NOM_NOM_DEVICE_NAME, TranslationKeys.TTT_GAME_SHOP_ITEM_NOM_NOM_DEVICE_DESCRIPTION),
    AXE(3, 2, 5, 5, ShopAxe.class, new ItemStack(Material.GOLDEN_AXE), TranslationKeys.TTT_GAME_SHOP_ITEM_AXE_NAME, TranslationKeys.TTT_GAME_SHOP_ITEM_AXE_DESCRIPTION),
    IRON_SWORD(3, 251, 1, 1, ShopIronSword.class, new ItemStack(Material.IRON_SWORD), TranslationKeys.TTT_GAME_SHOP_ITEM_IRON_SWORD_NAME, TranslationKeys.TTT_GAME_SHOP_ITEM_IRON_SWORD_DESCRIPTION),
    ...
    FIREBALL(4, 1, 5, 5, ShopFireball.class, new ItemStack(Material.FIREWORK_ROCKET), TranslationKeys.TTT_GAME_SHOP_ITEM_FIREBALL_NAME, TranslationKeys.TTT_GAME_SHOP_ITEM_FIREBALL_DESCRIPTION),
    TRAP_REPAIR(4, 1, 1, 1, ShopTrapRepair.class, new ItemStack(Material.TRIPWIRE), TranslationKeys.TTT_GAME_SHOP_ITEM_TRAP_REPAIR_NAME, TranslationKeys.TTT_GAME_SHOP_ITEM_TRAP_REPAIR_DESCRIPTION),
    BOOM_BODY(4, 1, 5, 5, ShopBoomBody.class, new ItemStack(Material.PLAYER_HEAD), TranslationKeys.TTT_GAME_SHOP_ITEM_BOOM_BODY_NAME, TranslationKeys.TTT_GAME_SHOP_ITEM_BOOM_BODY_DESCRIPTION),
    ...
    GENERATOR(5, 1, 5, 5, ShopGenerator.class, new ItemStack(Material.COMPARATOR), TranslationKeys.TTT_GAME_SHOP_ITEM_GENERATOR_NAME, TranslationKeys.TTT_GAME_SHOP_ITEM_GENERATOR_DESCRIPTION),
