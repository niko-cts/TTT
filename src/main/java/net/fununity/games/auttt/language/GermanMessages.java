...
public class GermanMessages extends MessageList {
    ...
    public GermanMessages() {
        ...
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_ARROWS_DESCRIPTION, "§7Hol dir Nachschub für;§7deinen Bogen. 10 Pfeile für;§7nur einen Punkt!;;&7Preis: &e<coinsanzahl> Coins");
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_TRAP_TICKET_NAME, "&eFallen-Stop");
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_TRAP_TICKET_DESCRIPTION, "§7Wird das Item gekauft, kann die;§7Traitor-Falle nicht mehr ausgelöst;§7werden. Wird dieses Item ein zweites;§7mal gekauft, ist das aktivieren wieder;§7möglich.;;&7Preis: &e<coinsanzahl> Coins");
        ...
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_RADAR_DESCRIPTION, "§7Zeigt dir den nähesten;§7oder einen ausgewählten;§7Spieler an.;;&7Preis: &e<coinsanzahl> Coins");
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_NOM_NOM_DEVICE_NAME, "&eNom-Nom Device");
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_NOM_NOM_DEVICE_DESCRIPTION, "§7Verspeise alle 60 Sekunden;§7eine Leiche um 2 Herzen zu;§7regenerieren.;;&7Preis: &e<coinsanzahl> Coins");
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_AXE_NAME, "&eStreitaxt");
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_AXE_DESCRIPTION, "§7Diese schwere Waffe fügt mit einem;§7Schlag 5 Herzen Schaden zu. Doch;§7durch ihr hohes Gewicht verlangsamst;§7du dich, selbst wenn du;§7die Axt wieder weggelegt hast.;;&7Preis: &e<coinsanzahl> Coins");
        ...
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_BOOM_BODY_DESCRIPTION, "§7Wird er von einem Detective oder;§7Innocent identifiziert macht es...;§7Richtig! Kaboom;;&7Preis: &e<coinsanzahl> Coins");
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_JIHAD_NAME, "&eSprengweste");
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_JIHAD_DESCRIPTION, "§7Diese spezielle Weste explodiert 5 Sekunden;§7nachdem du sie angezogen hast.;§7Du wirst den Einsatz dieses Items;§7allerdings nicht überstehen...;;&7Preis: &e<coinsanzahl> Coins");
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_TESTER_FAKER_NAME, "&eInnocent-Pass");
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_TESTER_FAKER_DESCRIPTION, "§7Du wirst dauernd verdächtigt? Dieser;§7Störsender beeinflusst den Traitor-Tester;§7so, dass du nicht als Traitor enttarnt;§7wirst, wenn du ihn betrittst.;;&7Preis: &e<coinsanzahl> Coins");
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_IDENT_THIEF_NAME, "&eIdentitätsdieb");
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_IDENT_THIEF_DESCRIPTION, "§7Täusche deine Verfolger und nimm;§7die Identität einer Leiche an.;§7Du spielst nun so lange als dieser;§7Spieler, bis die Leiche identifiziert wird.;;&7Preis: &e<coinsanzahl> Coins");
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_GENERATOR_NAME, "&eSaboteur");
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_GENERATOR_DESCRIPTION, "§7Mit diesem Item kannst du den;§7Generator deaktivieren. Für alle;§7Innocents und Detectives ohne;§7Nachtsichtgerät wird alles dunkel.;;&7Preis: &e<coinsanzahl> Coins");
        ...
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_SENTRYGUN_DESCRIPTION, "§7Ein mächtiger Geschützturm, der alles vernichtet, was ihm zu nahe kommt.;§7Sein Sichtfeld ist aber sehr eingeschränkt...;;&7Preis: &e<coinsanzahl> Coins");

        // INNOCENT
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_ANTI_BOOM_BODY_NAME, "&eBoomBody-Stop");
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_ANTI_BOOM_BODY_DESCRIPTION, "§7Verhindert, dass du einen;§7BoomBody identifizierst.;;&7Preis: &e<coinsanzahl> Coins");
        ...
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_NIGHTVISION_DESCRIPTION, "§7Selbst wenn der Generator sebotiert;§7wurde, kannst du mit diesem Gerät;§7im Dunklen sehen.;;&7Preis: &e<coinsanzahl> Coins");
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_SUPER_IDENT_NAME, "&eSuper-Identifizierer");
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_SUPER_IDENT_DESCRIPTION, "§7Erhalte schneller Einsicht in;§7die Akten und erhalte;§7zusätzliche Informationen zu;§7Leichen.;;&7Preis: &e<coinsanzahl> Coins");
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_HOOK_NAME, "&eEnterhaken");
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_HOOK_DESCRIPTION, "§7Triffst du einen Block mit;§7dem Enterhaken, kannst du;§7dich zu diesem hinziehen.;§7Triffst du einen Spieler, wird;§7dieser zu dir gezogen und erhält;§71 Herz Schaden.;;&7Preis: &e<coinsanzahl> Coins");
        ...
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_TRAP_BLOCK_DESCRIPTION, "§7Wird dieses Item gekauft, so;§7kann bei der nächsten Person,;§7die den Tester betritt nicht;§7die Falle ausgelöst werden.;;&7Preis: &e<coinsanzahl> Coins");
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_MOVE_SENSOR_NAME, "&eBewegungsmelder");
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_MOVE_SENSOR_DESCRIPTION, "§7Kann vor dem Ausgang aus;§7eines Lüftungsschachtes;§7aufgestellt werden und;§7alamiert, wenn ein Traitor;§7aus dem Schacht heraustritt.;;&7Preis: &e<coinsanzahl> Coins");
        ...
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_DETECTOR_DESCRIPTION, "§7Nähert sich ein Traitor bis;§7auf 10 Blöcke, färbt sich;§7der Detektor rot.;;&7Preis: &e<coinsanzahl> Coins");
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_VENT_GIFT_NAME, "&eGiftige Luft");
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_VENT_GIFT_DESCRIPTION, "§7Vergiftet die Luft in den;§7Lüftungsschächten für;§760 Sekunden.;;&7Preis: &e<coinsanzahl> Coins");
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_HEAL_STATION_NAME, "&eSamariter");
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_HEAL_STATION_DESCRIPTION, "§7Alle Spieler im Umkreis;§7von 2 Blöcken werden geheilt.;;&7Preis: &e<coinsanzahl> Coins");
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_ONE_SHOT_BOW_NAME, "&eOne-Shot-Bogen");
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_ONE_SHOT_BOW_DESCRIPTION, "§7Triffst du einen Spieler;§7mit diesem Bogen, so;§7stirbt dieser sofort.;;&7Preis: &e<coinsanzahl> Coins");
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_MED_KIT_NAME, "&eMedi-Kit");
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_MED_KIT_DESCRIPTION, "§7Wird das Medi-Kit angewendet,;§7werden sofort 5 Herzen;§7regeneriert.;;&7Preis: &e<coinsanzahl> Coins");
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_YOUTH_NAME, "&eJugend");
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_YOUTH_DESCRIPTION, "§7Erhöht die Kapazität an;§7maximalen Herzen um 2.;;&7Preis: &e<coinsanzahl> Coins");
