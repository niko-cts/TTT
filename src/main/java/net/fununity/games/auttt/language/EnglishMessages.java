...
public class EnglishMessages extends MessageList {
    ...
    public EnglishMessages() {
        ...
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_ARROWS_DESCRIPTION, "&7Get 10 arrows for your bow.;;&7Cost: &e${cost} Coins");
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_TRAP_TICKET_NAME, "&eFallen-Stop");
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_TRAP_TICKET_DESCRIPTION, "&7If this item get bought,;&7the traitor trap won't work anymore.;&7If you buy this another time,;&7it can be activated it again.;;&7Cost: &e${cost} Coins");
        ...
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_RADAR_DESCRIPTION, "&7Shows you the closest player to you.;;&7Cost: &e${cost} Coins");
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_NOM_NOM_DEVICE_NAME, "&eNom-Nom Device");
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_NOM_NOM_DEVICE_DESCRIPTION, "&7Consume every 60 seconds a body;&7 to regenerate 10 hearts.;;&7Cost: &e${cost} Coins");
        ...
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_FIREBALL_DESCRIPTION, "&7This fiery ball leaves an ocean of flames;&7on his impact point.;;&7Cost: &e${cost} Coins");
        ...
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_BOOM_BODY_DESCRIPTION, "&7If it gets identified from a detective or innocent,;&7it will make....;&7right! boom!;;&7Cost: &e${cost} Coins");
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_JIHAD_NAME, "&eExplosive Vest");
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_JIHAD_DESCRIPTION, "&7This special vest will explode after 5 seconds;&7when you equip it.;&7But sadly you won't survive it...;;&7Cost: &e${cost} Coins");
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_TESTER_FAKER_NAME, "&eInnocent-Pass");
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_TESTER_FAKER_DESCRIPTION, "&7Are you always suspected?;&7That jammer influences the traitor-tester;&7that you won't be shown as a traitor;&7 when you enter it.;;&7Cost: &e${cost} Coins");
        ...
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_GENERATOR_DESCRIPTION, "&7With this item, you can deactivate the generator.;&7For every innocent and detective without a night vision device,;&7it will be dark.;;&7Cost: &e${cost} Coins");
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_INVISIBILITY_NAME, "&eCamouflage Cap");
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_INVISIBILITY_DESCRIPTION, "&7Disappear for 30 seconds in the guard;&7of the invisibility.;;&7Costs: &e${cost} Coins");
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_SENTRYGUN_NAME, "&eSentryGun");
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_SENTRYGUN_DESCRIPTION, "&7A powerful gun tower who destroys everything;&7that gets too close to him.;&7Unfortunately, his view is limited.;;&7Cost: &e${cost} Coins");

        // INNOCENT
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_ANTI_BOOM_BODY_NAME, "&eBoomBody-Stop");
        add(TranslationKeys.TTT_GAME_SHOP_ITEM_ANTI_BOOM_BODY_DESCRIPTION, ";;&7Cost: &e${cost}${cost} Coins");
